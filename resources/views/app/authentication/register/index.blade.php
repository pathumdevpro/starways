                        ...
                        <div class="card p-15">
                            ...
                            <form action="{{ route('register') }}" method="post">
                                ...
                                <div class="form-group">
                                    <label class="required" for="name">Enter name</label>
                                    <input autocomplete="off" class="form-control" id="name" maxlength="255" name="name" placeholder="Name" required type="text">
                                </div>
                                <div class="form-group">
