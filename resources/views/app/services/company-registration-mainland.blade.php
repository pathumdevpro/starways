@php
$id = 'company-registration-mainland';
        ...
        <div class="flex-work-page">
            <div class="utility-left-column">
                <div class="work-overview">
                    ...
                    <div class="side-block">
                        ...
                        <div class="text-gray contact-details-box">
                            <div class="text-gray w-richtext">
            ...
            <div class="utility-right">
                <div class="post-heading-box">
                    ...
                    <h1 class="less-top-margin mt-25"><x-markdown>{{ $cms[7]->content }}</x-markdown></h1>
                    <x-markdown>{{ $cms[8]->content }}</x-markdown>
                    <h1 class="less-top-margin mt-25"><x-markdown>{{ $cms[9]->content }}</x-markdown></h1>
                    <x-markdown>{{ $cms[10]->content }}</x-markdown>
                    <h1 class="less-top-margin mt-25"><x-markdown>{{ $cms[11]->content }}</x-markdown></h1>
                ...
                <div class="w-richtext">
                    ...
                    <h3><x-markdown>{{ $cms[15]->content }}</x-markdown></h3>
                    <x-markdown>{{ $cms[16]->content }}</x-markdown>
                </div>
            </div>
        </div>
    </div>
