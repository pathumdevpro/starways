@php
$id = 'office-flexi-desk-arrangement';
$title = 'Office Flexi Desk Arrangement';
@endphp
...
<div
    id="Top"
    style="background-image: url({{ $cms[16]->content && Storage::exists('cms/' . $cms[16]->content) 
    ? Storage::url('cms/' . $cms[16]->content) 
    : asset($cms[16]->image) }})"
    class="utility-hero">
